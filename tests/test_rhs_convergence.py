...
def test_rhs_convergence_allen_cahn():
    ...
    R_sym  = lambda u: 1 + u**2    # variable mobility
    ...
    dx, errors = check_convergence(AllenCahn2DPeriodic, SymbolicAllenCahn2DPeriodic, numeric_args, symbolic_args, Ns, 2*np.pi)
...
def test_rhs_convergence_cahn_hilliard():
    ...
    dx, errors = check_convergence(CahnHilliard2DPeriodic, SymbolicCahnHilliard2DPeriodic, numeric_args, symbolic_args, Ns, 2*np.pi)
